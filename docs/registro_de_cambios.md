...
Este documento mantiene un registro de las etapas y versiones del desarrollo de este proyecto:

- **(31/mar/26) Etapa 0**: Creación del ambiente virtual y configuración de herramientas
- **(2/abr/26) Etapa 1**: Implementación de endpoints básicos de usuarios
